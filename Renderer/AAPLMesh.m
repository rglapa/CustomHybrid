                          ...
                          metalKitTextureLoader:(nonnull MTKTextureLoader *)textureLoader
{
    ...
    if(self)
    {
        ...
        // Fill up the texture array with nulll objects so that the renderer can index it.
                                       ...
                                       error:(NSError * __nullable * __nullable)error
{
    ...
    [modelIOMesh addNormalsWithAttributeNamed:MDLVertexAttributeNormal creaseThreshold:0.98];
